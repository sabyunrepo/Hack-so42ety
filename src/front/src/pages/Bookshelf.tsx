    ...
    return (
      <div className="p-8 bg-gradient-to-br from-orange-50 to-amber-50 h-full flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="text-2xl font-bold text-amber-900 tracking-wide">책장을 불러오는 중...</div>
  ...
  return (
    <div className="p-8 bg-gradient-to-br from-orange-50 via-amber-50/50 to-orange-50 h-full">
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-4xl font-bold text-amber-900 tracking-tight">나의 책장</h1>
      ...
      <div className="space-y-12">
        {bookShelves.map((shelf, shelfIndex) => (
          <div key={shelfIndex} className="relative">
                ...
                <Link to="/create" className="group">
                  <div className="h-[228px] w-[171px] border-[3px] border-dashed border-amber-400/50 rounded-[13px] flex items-center justify-center bg-white/40 backdrop-blur-sm hover:bg-amber-50/60 hover:border-amber-500 transition-all duration-300 shadow-md hover:shadow-xl hover:scale-105 cursor-pointer">
                    <div className="text-center">
                      <div className="text-6xl mb-2 text-amber-500 group-hover:text-amber-600 transition-colors group-hover:scale-110 transform duration-300">+</div>
                      <p className="text-sm font-semibold text-amber-700 group-hover:text-amber-800">새 책 만들기</p>
                    </div>
                  </div>
                </Link>
              )}
            ...
            {/* 선반 - 개선된 3D 효과 */}
            <div className="w-full h-8 rounded-lg shadow-2xl relative overflow-hidden mt-2" style={{ backgroundColor: "#A0826D" }}>
              {/* 상단 하이라이트 */}
      ...
      {books.length === 0 && (
        <div className="flex flex-col items-center justify-center py-20">
          ...
          <h2 className="text-3xl font-bold text-amber-800 mb-3">아직 책이 없습니다</h2>
